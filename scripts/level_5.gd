...
func _ready():
	...
	GameManager.target = 16
	GameManager.duration = 40.0
	var we = get_node_or_null("WorldEnv")
	if we and we.environment:
		var env = we.environment
		env.background_mode = Environment.BG_COLOR
		env.background_color = Color(0.15, 0.03, 0.03, 1)
		env.ambient_light_color = Color(0.4, 0.1, 0.1, 1)
		env.ambient_light_energy = 0.35
		env.fog_enabled = true
		env.fog_mode = Environment.FOG_MODE_DEPTH
		env.fog_density = 0.018
		env.fog_light_color = Color(0.2, 0.05, 0.05, 1)
...
func _create_ui():
	...
	var buttons_data = {
		"StartBtn": {"text": I18n.t("play_level_1"), "pos": 0.22, "vis": true},
		"NextBtn": {"text": I18n.t("next_level"), "pos": 0.22, "vis": false},
		"RestartBtn": {"text": I18n.t("restart"), "pos": 0.38, "vis": false},
		"Level2Btn": {"text": I18n.t_arr("level_names")[1], "pos": 0.38, "vis": false},
		"Level3Btn": {"text": I18n.t_arr("level_names")[2], "pos": 0.30, "vis": false},
		"BackMenuBtn": {"text": I18n.t("back_to_menu"), "pos": 0.46, "vis": false},
		"QuitBtn": {"text": I18n.t("quit"), "pos": 0.46, "vis": false},
	}
