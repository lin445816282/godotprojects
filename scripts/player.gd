...
func create_particles():
	...
	mat.initial_velocity = 4.0
	mat.initial_velocity_random = 1.0
	mat.angular_velocity = 5.0
	mat.angular_velocity_random = 2.0
	mat.scale = 1.0
	mat.scale_random = 0.5
	mat.color = Color(1, 0.85, 0.1, 1)
	mat.lifetime_randomness = 0.3
	mat.damping = 3.0
	mat.damping_random = 1.0
